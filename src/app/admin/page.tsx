...
export default function AdminHome(){
  ...
  return <main className="admin-shell">
    <header className="admin-top"><div><span className="eyebrow">HU3 PET · GAME MASTER</span><h1>Centro de controle</h1></div><div style={{display:"flex",gap:8}}><a className="admin-link" href="/admin/content">🎯 Eventos & Missões</a><a className="admin-link" href="/admin/items">🎒 Editor de itens</a></div></header>
